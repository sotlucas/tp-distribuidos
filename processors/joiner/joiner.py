...
class Joiner(Processor):
    ...
    def process(self, message):
        ...
        starting_airport_lat_long = self.config.lat_long_airports[starting_airport]
        destination_airport_lat_long = self.config.lat_long_airports[destination_airport]
